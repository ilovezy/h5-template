  ...
  <layout :showNavbar="isNavbar">
    <mu-container>
      ...
      <mu-dialog title="Use Google's location service?" width="600" max-width="80%" :esc-press-close="false" :overlay-close="false" :open.sync="openAlert">
        ...
        <mu-button slot="actions"  color="primary" @click="closeAlertDialog">Disagree</mu-button>
        <mu-button slot="actions"  color="primary" @click="closeAlertDialog">Agree</mu-button>
      </mu-dialog>
    </mu-container>
  </layout>
</template>
