  ...
  <layout :showNavbar="isNavbar">
    ...
    <section class="protocol-group">
      <div class="protocol-body">
        <h1 style='font-size: 30px; margin-bottom: 0.5rem;'>风险揭示书</h1>
        <div class="protocol-info protocal-main">
          <p> 尊敬的客户：</p>
          <p class='indent2'>以上闪电借条为平台的期货授信业务是一种潜在收益和潜在风险较 高的投资品种，对客
            户理解风险的能力、控制风险的能力、承受风险的能力以及投资经验 都有较高的要求。客户
            签署本协议书，代表对闪电借条业务的风险已有充分的认知及了 解。</p>
          ...
          <p>若客户对于本揭示书有不理解或不清晰的地方，应该及时向闪电借条咨询相关信息， 对
            揭示书不存在任何异议时，请亲自确认</p>
          <p>一、温馨提示</p>
          ...
          </p><p>期货授信交易业务通过电子通讯技术和互联网技术来实现。有关通讯服务及软、硬件服务由
          ...
          </p><p>（1） 客户需要了解交易市场的期货投资业务具有杠杆比例，盈亏波动较大的特点。若建仓的 方
          向与行情的波动相反，会造成较大的亏损。根据亏损的程度，客户必须有条件满足随时追加预
          付款的要求，否则其持仓可能会被强行平仓，客户必须承担由此造成的全部损失。
          </p><p>（2） 客户在交易市场的交易系统内，通过网上终端所提交的市价单一经成交，即不可撤 销，
          客户必须接受这种方式可能带来的风险。
          </p><p>（3） 客户通过杭州壮云电子商务以电话的方式下市价单，一经交易部报价确认后，即不可 撤
          销或撤回，客户必须接受此种报单方式有可能带来的风险。
          </p><p>（4） 杭州壮云电子商务及其工作人员不会对客户作出获利保证，并且不会与客户分享收益 或
          共担风险。客户应知晓针对期货授信交易业务的任何获利保证或者不会发生亏损的承诺 均为
          不可能和没有根据的。
          </p><p>（5） 客户的成交单据必须是建立在自己的自主决定之上。杭州壮云及其员工提供的任何关 于
          市场的分析和信息，仅供客户参考，同时也不构成任何要约。客户因参考或采纳以上信 息而
          造成的交易风险由客户自行承担。
          </p><p>（6） 在电话以及电子交易过程中，由于技术故障或其他不可抗力因素，有可能出现偶然性 的
          错误报价，交易市场有权在事后对错价及错价产生的盈亏作出纠正，客户应接受相关纠 错行
          为，由此而造成的交易风险由客户承担。
          </p><p>（五）不可抗力风险
          </p><p>任何因交易市场不能够控制的原因，包括但不限于地震、水灾、火灾、暴动、罢工、战争、
          政府管制、国际或国内的禁止或者限制以及停电、技术故障、电子故障等其他无法预测和防
          范的不可抗力事件，都有可能会对客户的交易产生影响，客户应该充分了解并承担由此造成
          的全部损失。</p>

          <p>三、特别提示
          </p><p>1. 客户在参与投资之前务必详尽的了解期货投资投资的基本知识和相关风险以及交易市场
          有关的业务规则等，依法合规地从事期货投资业务。
          </p><p>2. 闪电借条与现有的期货投资交易市场相比，在交易模式、交易规则等方面完全一致，港
          唯国际为了确保市场“公开、公平、公正”和健康稳定地发展，将采取更加严格的措施以
          强化市场的监管。请客户务必密切关注闪电借条的公告、风险提示等信息，及时了解市场 风
          险状况，做到理性投资，切忌盲目跟风。
          </p><p>3. 客户在开通交易之前，请配合闪电借条完成客户的适当性管理工作，完整、如实地提供
          开户所需要的信息，不得采取弄虚作假等手段规避相关要求，否则，杭州壮云有权拒绝为 客
          户开通服务。
          </p><p>4. 本风险提示书提及的上述风险揭示事项仅为列举性质，未能详尽的列明交易市场期货投资交 易
          的所有风险，客户参与投资之前，还应认真对其他可能存在的风险有所了解和掌握。
          </p><p>5. 我们诚挚的希望和建议客户，从自身风险承受能力等实际情况出发，审慎地决定是否参
          与期货投资。
          </p><p>关于禁止代客交易的说明
          </p><p>禁止代客交易及变相代客交易，严厉禁止我单位及下辖业务体系内的任何机构或个人向您提
